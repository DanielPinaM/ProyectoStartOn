...
<html>
  ...
  <body>
      ...
      <div class="row"> <!--Row POL PRIVACIDAD-->
      ...
      <div class="row"> <!--Row titulo-->
        <div>
          <p>StartOn te informa sobre su Política de Privacidad respecto del tratamiento y protección de los datos de carácter personal de los usuarios y clientes que puedan ser recabados por la navegación o contratación de servicios a través del sitio Web www.starton.es.
      ...
      <div class="row"> <!--Row titulo-->
        <div>
          <p>Principio de integridad y confidencialidad: Tus datos serán tratados de tal manera que su seguridad, confidencialidad e integridad esté garantizada.
          ...
          Obtención de datos personales</p>
          <p>Para navegar por StartOn no es necesario que facilites ningún dato personal.</p>
        </div>
      </div>
  </div>
</body>
