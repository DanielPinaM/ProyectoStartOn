...
<html>
  ...
  <body>
      ...
      <div class="row"> <!--/Row body-->
        <div> <!--Div Parrafo-->
  				<p>Nuestro proyecto se trata de una web para poner en contacto a personas interesadas en el mundo del emprendimiento que estén el la etapa laboral de su vida con startups en cualquier fase que quieran buscar a nuevos integrantes en sus equipos.</p>
  			</div>
